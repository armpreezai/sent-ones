...
const RegistrationModal = ({ isOpen, onClose, type, title, eventName }: { isOpen: boolean, onClose: () => void, type: 'gods_girls' | 'mens_breakfast' | 'home_group' | 'event', title: string, eventName?: string }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/connect-registration', {
        method: 'POST',
    ...
    <div className="space-y-8 pb-24">
      ...
      <section className="px-4 space-y-6">
        <div className="grid grid-cols-2 gap-4">
          <div className="overflow-hidden rounded-2xl shadow-md aspect-[3/4]">
            <img 
              src="/Pictures/Benoni Service times.png" 
      ...
      <section className="px-4 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="overflow-hidden rounded-2xl shadow-sm">
            <img 
              src="/Pictures/Kingdom Kiddies.JPG" 
              className="w-full h-auto block" 
              alt="Kingdom Kiddies"
              referrerPolicy="no-referrer"
            />
      ...
      <section className="px-4">
        ...
        >
          <img 
            src="/Pictures/Statement of faith.JPG" 
  ...
  return (
    <div className="space-y-8 pb-24">
      ...
      <section className="px-4 space-y-6">
        ...
        <div className="space-y-6">
          <img 
            src="/Pictures/Ps. Al and Nat.JPG" 
...
const ServicesScreen = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsSubmitting(true);
    try {
      const response = await fetch('/api/register-kingdom-kiddies', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
    ...
    <div className="space-y-1 pb-0">
      ...
      <section className="px-4">
        <div className="flex justify-center mt-4">
          <img 
            src="/Pictures/Kingdom Kiddies picture.JPG" 
            alt="Kingdom Kiddies" 
        ...
        <div className="flex justify-center -mt-6">
          <img 
            src="/Pictures/Kingdom Kiddies Logo.png" 
      ...
      <div className="max-w-6xl mx-auto px-4 space-y-16">
        ...
        <section className="space-y-4">
          <div className="flex flex-col items-center space-y-2">
            <img 
              src="/Pictures/Breakthrough Prayer.png" 
        ...
        <section className="space-y-4">
          <div className="flex flex-col items-center space-y-2">
            <img 
              src="/Pictures/Blue-Print-Youth.png" 
              alt="Blueprint Youth" 
              className="w-full max-w-5xl h-auto object-contain"
              referrerPolicy="no-referrer"
            />
          ...
          <div className="grid md:grid-cols-2 gap-4 items-center">
            <div className="rounded-3xl overflow-hidden shadow-xl transform -rotate-1 hover:rotate-0 transition-transform duration-500 w-full">
              <img 
                src="/Pictures/BluePrint image.GIF" 
                alt="Young Adults" 
                className="w-full h-full object-cover aspect-[4/3]"
                referrerPolicy="no-referrer"
              />
        ...
        <section className="space-y-4">
          <div className="flex justify-center">
            <img 
              src="/Pictures/Christian Counselling.png" 
      ...
      <section className="px-4 space-y-6">
        ...
        <div className="pt-8">
          ...
          <div className="mt-8 flex justify-center">
            <img 
              src="/Pictures/Spirit-life-website-19-300x300.png" 
    ...
    <div className="space-y-8 pb-24">
      ...
      <section className="px-4 space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex justify-center">
            <img 
              src="/Pictures/School-of-the-prophetic.png" 
...
const SoulAnchoredScreen = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsSubmitting(true);
    try {
      const response = await fetch('/api/soul-anchored-request', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formData),
      });
      ...
      <div className="max-w-md mx-auto bg-white min-h-screen shadow-2xl relative flex flex-col">
        ...
        <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-black/5 px-4 h-28 flex items-center justify-between">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 flex items-center">
            <img src="/Pictures/Sent Ones Logo-Photoroom.png" alt="Logo" className="h-24 w-auto" referrerPolicy="no-referrer" />
          </div>
          <button 
            ...
            <div className="max-w-7xl mx-auto space-y-12 text-sm">
              ...
              <div className="flex flex-col items-center space-y-6">
                <div className="flex flex-col items-center gap-2">
                  <img src="/Pictures/Sent Ones Logo-Photoroom.png" alt="Logo" className="h-20 w-auto" referrerPolicy="no-referrer" />
                  <div className="text-center">
              ...
              >
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-2">
                    <img 
                      src="/Pictures/Sent Ones Logo-Photoroom.png" 
                      alt="Sent One's Logo" 
